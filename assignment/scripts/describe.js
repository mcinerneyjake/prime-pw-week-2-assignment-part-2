...
// We check that the variable code is equal to the number 123.
...
// We then check that code is greater than 250. If true, we assign the value of 'duper' to secret.
...
// FIX - to clarify the statement, minAge <= age should be changed to age >= minAge.
// FIX - 'no entry' and 'enter' should be flipped so that 'enter' is logged to the console.
if(minAge <= age) {
